...
public class SplineFollowerOBSOLETE : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        spline = splineGenerator.SplinePoints;
        ...
        //Target
        Vector3 target = Vector3.zero; // e.g. 5f
    ...
    //{
    //    if (navigation == null || splineGenerator.SplinePoints == null) return;
